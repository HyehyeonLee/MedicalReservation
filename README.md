...
<ul>
  ...
  <li>회원가입 - 다음(카카오) 우편번호 API 연동, 비밀번호 유효성 검사, SHA-256을 사용한 비밀번호 암호화</li>
  <li>비밀번호 찾기 - 난수를 발생시켜 임시 비밀번호 생성, JAVA mail API를 사용하여 회원가입 시 입력한 email로 임시 비밀번호 발급</li>
